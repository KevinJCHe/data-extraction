...
def extract_nutrient(queries):
    ...
    #Stage 2
    #extract ndbno number using beautiful soup
    for r in range(len(queries)):
        query = queries[r][0]
        print query

        #if query word is two words like cheddar cheese, switch the words, search for cheese%cheddar
        if len(query.split()) == 2:    
            que_words = query.split()
            url_query = que_words[1]+"%20"+que_words[0]    
            #for the actual text, search for cheese, cheddar                
            text_query = (que_words[1] + ", "+que_words[0]).lower()        
        ...
        if found_it == False:
            #Turn onion powder to onion%powder
            ...
            if found_it == False:
                ...
                if found_it == False:
                    #if query word is more than one word, split them up
                    if len(query.split()) > 1:  
                        ...
                        if found_it == False:
                            ...
                            if found_it == False:
                                #Take the last word e.g.japanese eggplants to eggplants
                                last_word = que_words[-1]
                                print last_word
                                ...
                                if found_it == False:
                                    ...
                                    if found_it == False:
                                        ...
                                        if last_word[len(last_word) - 1] == "s":
                                            ...
                                            print last_word
                                            #Do find_raw_or_fluid_alg with removed s word
                                            found_it = find_raw_or_fluid_alg(soup_last_word,last_word)   
                                            if found_it == False:
    ...
    for r in range(len(removed_queries_final)):
        ...
        if found_it == False:
            ...
            if found_it == False:
                ...
                if found_it == False:
                    #if query word is more than one word
                    if len(query.split()) > 1:    
                        que_words = query.split()
                        found_it = every_word_appear_alg(soup_1,que_words)
                                    ...
                                    found_it = closest_query_word_alg(soup_last_word,last_word)
                                   	...
                                   	if found_it == False:
                                        ...
                                        if last_word[len(last_word) - 1] == "s":    
                                            ...
                                            found_it = find_raw_or_fluid_alg(soup_last_word,last_word)
                                            if found_it == False:
                                            	#Do closest_query_word_alg with removed s word
                                                found_it = closest_query_word_alg(soup_last_word,last_word)  
    ...
    #extract nutrient information using ndbno number
    for n in range(len(ndbno)):
    ...
    #Remove the queries and ndbno that were not found / was empty to prevent list index out of range errors
...
if __name__ == "__main__":
    ...
    '''
    #First Parameter = Ingredient_Name, Second Paramenter = Ndbno number that you want
    update_nutrient_data("brown sugar", "19334")    
